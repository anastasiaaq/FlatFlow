...
export default function ChoreFormModal({
  ...
  const inputClass =
    'w-full bg-[#fffef7] rounded-[7px] border border-[#d8d8bd] h-[43px] px-[12px] text-[#0b0a0f] text-[14px] font-normal placeholder-[#aaa] placeholder:font-normal focus:ring-2 focus:ring-[#fdd329]'
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-[20px]">
            ...
            <div>
              ...
              <textarea
                ...
                maxLength={500}
                rows={4}
                className="w-full bg-[#fffef7] rounded-[7px] border border-[#d8d8bd] px-[12px] py-[10px] text-[#0b0a0f] text-[14px] font-normal placeholder-[#aaa] placeholder:font-normal focus:ring-2 focus:ring-[#fdd329] resize-none"
              />
            </div>
