...
| Status | Fail |
| Actual result (if Fail) | HTTP 500 — NotSupportedError: 'FOR UPDATE cannot be applied to the nullable side of an outer join'; PATCH assignee failed. |
...
| Status | Fail |
| Actual result (if Fail) | HTTP 500 — NotSupportedError: 'FOR UPDATE cannot be applied to the nullable side of an outer join'; PATCH assignee=null failed. |
| Severity (if Fail) | Critical |
...
| Status | Fail |
| Actual result (if Fail) | HTTP 500 — NotSupportedError: 'FOR UPDATE cannot be applied to the nullable side of an outer join'; POST complete (Task) failed. |
| Severity (if Fail) | Critical |
...
| Status | Fail |
| Actual result (if Fail) | HTTP 500 — NotSupportedError: 'FOR UPDATE cannot be applied to the nullable side of an outer join'; POST complete (Duty) failed. |
| Severity (if Fail) | Critical |
...
| Status | Fail |
| Actual result (if Fail) | Returned HTTP 500 — NotSupportedError: 'FOR UPDATE cannot be applied to the nullable side of an outer join' instead of the expected HTTP 400 — the complete endpoint hits the same error before validation. |
| Severity (if Fail) | Critical |
...
| Status | Fail |
| Actual result (if Fail) | HTTP 500 — NotSupportedError: 'FOR UPDATE cannot be applied to the nullable side of an outer join'; PATCH status (reopen) failed. |
| Severity (if Fail) | Critical |
...
| Status | Fail |
| Actual result (if Fail) | HTTP 500 — NotSupportedError: 'FOR UPDATE cannot be applied to the nullable side of an outer join'; PATCH edit failed. |
| Severity (if Fail) | Critical |
...
| Status | Fail |
| Actual result (if Fail) | HTTP 500 — NotSupportedError: 'FOR UPDATE cannot be applied to the nullable side of an outer join'; PATCH type failed — the type-lock 400 cannot be verified until the 500 is fixed. |
| Severity (if Fail) | Critical |
...
| Status | Fail |
| Actual result (if Fail) | HTTP 500 — NotSupportedError: 'FOR UPDATE cannot be applied to the nullable side of an outer join'; DELETE failed, chore not removed. |
| Severity (if Fail) | Critical |
